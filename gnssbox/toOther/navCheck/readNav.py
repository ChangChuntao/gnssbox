...
def readNav(navFile):
    ...
    for sat in navHead:
        navDataPrn = []
        for epoch in navHead[sat]:
            satLineIndex = sat + ' ' + str(epoch.year) + ' ' + '%02d' % epoch.month + ' ' + \
                '%02d' % epoch.day + ' ' + '%02d' % epoch.hour + ' ' +\
                    '%02d' % epoch.minute + ' ' + '%02d' % epoch.second
            for lineNum in range(endHeadLine, len(navFileLine)):
                if satLineIndex in navFileLine[lineNum]:
                    if sat[0] == 'C':
                        ...
                        navDataPrn.append(bdsNav(epoch, SVclockBias, SVclockDrift, SVclockDriftRate,
                        ...
                        navDataPrn.append(gpsNav(epoch, SVclockBias, SVclockDrift, SVclockDriftRate,
                        ...
                        navDataPrn.append(galileoNav(epoch, SVclockBias, SVclockDrift, SVclockDriftRate,
                        ...
                        navDataPrn.append(glonassNav(epoch, SVclockBias, SVrelativeFrequencyBias, MessageFrameTime,
                        ...
                        navDataPrn.append(qzssNav(epoch, SVclockBias, SVclockDrift, SVclockDriftRate,
                                                 IODE, Crs, DeltaN, M0, Cuc, e, Cus,
                                                 sqrtA, toe, Cic, OMEGA0, Cis,
                                                 i0, Crc, omega, OMEGA_DOT, IDOT, L2Codes, GPS_Week, L2PdataFlag,
                        ...
                        navDataPrn.append(sbasNav(epoch, SVclockBias, SVrelativeFrequencyBias, Transmission,
                                                     posX, velX, accelerationX, health,
                        ...
                        navDataPrn.append(irnssNav(epoch, SVclockBias, SVclockDrift, SVclockDriftRate,
                                                 IODEC, Crs, DeltaN, M0, 
                                                 Cuc, e, Cus,sqrtA, 
                                                 toe, Cic, OMEGA0, Cis,
                    ...
                    break
        print(sat)
        print(navDataPrn[0].Epoch)
        navData[sat] = navDataPrn
    return navData