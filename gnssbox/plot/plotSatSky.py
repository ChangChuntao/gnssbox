...
def plotSatSky(**kwargs):
    # datetime\coord为必选参数，sp3File与brdcFile必指定其一，其他为可选参数
    ...
    # brdcFile ：广播星历文件，例如：brdcFile = 'D:\Code\gnssbox\gnssbox\ioGnss\Example\brdm0020.22p'
    ...
    elif 'brdcFile' in kwargs:
        brdcData = readBrdc(kwargs['brdcFile'])
    else:
        print('参数未被正确指定')
        sys.exit()
    # 导航系统选择
